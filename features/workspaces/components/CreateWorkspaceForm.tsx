...
export function CreateWorkspaceForm() {
  ...
  const onSubmit = async (values: FormValues) => { setError(''); const result = await createWorkspace(values); if (result?.error) return setError(result.error); router.push('/dashboard') }
